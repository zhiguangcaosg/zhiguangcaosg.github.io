...
<p align="justify">Recently, I focus on <font color="#0000E3"><b>Neural Combinatorial Optimization (NCO)</b></font>, where I exploit Deep Reinforcement Learning to solve the classic Combinatorial Optimization Problems, such as Vehicle Routing Problem, Job Shop Scheduling Problem, Bin Packing Problem, Constraint Satisfaction Problem, and (Mixed) Integer Programming Problem. It is a hot topic for both AI and Operations Research, quite interesting yet challenging. Welcome to use our <a href="https://zhiguangcaosg.github.io/publications/"  target="_blank"> <font color="#FF0000"><b>CODE</b> </font></a>.
</p>
<li>	    
