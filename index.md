...
<p align="justify">Recently, I focus on exploiting Deep (Reinforcement) Learning to solve Combinatorial Opitimization Problems (<b>DRL4COP</b>), such as Vehicel Routing Problem, Job Shop Scheduling Problem, Bin Packing Problem, and (Mixed) Integer Programming Problem. This topic is quite interesting yet challenging, welcome for discussion.
</p>
<li>	    
